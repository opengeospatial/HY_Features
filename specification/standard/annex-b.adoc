...
|nearby |located in a short distance to the (reference) location.
...
|annular |main rivers have circular pattern with subsidiary channels at
right angles.

|centripetal |streams flow inward to center.

|dendritic |spreading treelike arrangement; no evident orientation of
