...
:titletext: OGC® WaterML 2: Part 3 - Surface Hydrology Features (HY_Features) - Conceptual Model
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/hy-features/1.0
|Internal reference number of this OGC(R) document:    14-111r6
|Version: 1.0
